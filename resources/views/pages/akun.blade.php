                                        ...
                                        <div id="editModal{{ $item->id }}" class="modal fade" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="akun/edit/{{ $item->id }}" method="post" novalidate>
                                                        @csrf
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                <div class="col-md-6">
        ...
        <div id="tambahModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form action="/akun/create" method="post" novalidate>
                        @csrf
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="level" id="" class="form-control select2"
                                            style="width: 100%">
                                            <option selected="selected">Pilih role akses
                                            </option>
                                            <option value="siswa">Siswa</option>
                                            <option value="Pemonitor">Pemonitor</option>
                                        </select>
